...
namespace Unnamed {
	...
	private:
		...
		std::string mElapsedFractionWidgetName =
			"CourseProgressElapsedFraction";
		std::string mElapsedCommaWidgetName = "CourseProgressElapsedComma";
		std::string mElapsedDotWidgetName   = "CourseProgressElapsedDot";
		Path mPinTexturePath         = Path("textures/ping.png");
		Path mArrowTexturePath       = Path("textures/arrow.png");
