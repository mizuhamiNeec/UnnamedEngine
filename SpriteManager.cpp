...
void SpriteManager::CreateRootSignature() {
	...
	// バイナリを元に生成
	hr = renderer_->GetDevice()->CreateRootSignature(0, signatureBlob->GetBufferPointer(), signatureBlob->GetBufferSize(),
