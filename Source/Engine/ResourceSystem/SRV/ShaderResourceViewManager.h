...
public:
	...
	void BindDescriptorTable(
		...
		ID3D12GraphicsCommandList* commandList, UINT rootParameterIndex) const;
	D3D12_GPU_DESCRIPTOR_HANDLE AllocateAndCopyDescriptors(
		const std::vector<D3D12_GPU_DESCRIPTOR_HANDLE>& handles) const;
