...
struct ImGuiStyle
{
    ...
    float       MouseCursorScale;           // ScaleMat software rendered mouse cursor (when io.MouseDrawCursor is enabled). We apply per-monitor DPI scaling over this scale. May be removed later.
